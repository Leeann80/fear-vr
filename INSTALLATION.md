...
2. Expand **Assets** if needed. Download **fear-vr-v0.1.0.zip** and
   **fear-vr-v0.1.0.zip.sha256**. Ignore GitHub's automatic Source code archives.
...
4. In the folder containing the ZIP, open PowerShell and run:
   ...
   ```powershell
   Get-FileHash -Algorithm SHA256 -LiteralPath '.\fear-vr-v0.1.0.zip'
   ```
